...
- 해당 팀 프로젝트에서 혼자 13개의 데이터 베이스 설계를 진행하며 관계형 데이터 베이스 설계와 구축에 대한 이해도를 높일 수 있었습니다.
- 더불어, 팀 회의에서 3회에 걸쳐 테이블 설계 진행 상황과 각 테이블의 연관 관계 등에 대해 설명하고, 설계 내용을 공유함으로써 팀원들의 이해를 도왔습니다.
- 또한, 팀 프로젝트에서의 Git 브랜치 전략, 협업 방식, 설계 진행 등 프로젝트 개발 과정에서의 협업에 대한 이해도를 높일 수 있었습니다.
